...
for params in grid:
  ...
  subprocess.call("python train.py -d ml_100k --accum " + ac +" -do " + dr + " -nleft -nb 2 -e " + epoch + " --features --feat_hidden "+ hf +" --testing --learning_rate " + lr + " --hidden " + "[" + str(params['hn'][0]) + "," +str(params['hn'][1]) + "]" ,shell=True)
