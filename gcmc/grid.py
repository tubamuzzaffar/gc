...
param_grid = {'epoch' :[1000, 100, 50,500, 750,250, 350, 450]}
...
#  second = str(x[1])
  ...
  subprocess.call("python train.py -d ml_100k --accum stack -do 0.7 -nleft -nb 2 -e " + epoch + " --features --feat_hidden --testing" ,shell=True)
